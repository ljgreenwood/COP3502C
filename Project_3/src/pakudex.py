...
class Pakudex:
    ...
    def add_pakuri(self, species):
        try:
            ...
            return False
            # unsuccessful in adding the Pakuri to the pocket

    def get_species_array(self):
        try:  # attempt at getting list
            temp = list(self.pocket.keys())  # access the keys of the pakuri pocket dict and cast to a list
    ...
    def get_stats(self, species):
        try:
            pakuri_obj = self.pocket[species]  # object of species (will exit if KeyError) (species isn't found)
            return [pakuri_obj.get_attack(), pakuri_obj.get_defense(), pakuri_obj.get_speed()]  # [attack, defense, speed]
        except:
            return None
    ...
    def evolve_species(self, species):
        try:
            pakuri_obj = self.pocket[species]  # pakuri object of species (will exit if KeyError - species not found)
